...
const PadmaTheme = ( { seoData, foreignData }: { seoData: any, foreignData: any } ) => {
  const slug = 'padma-multipurpose-frontity-theme'
  // call data using swr
  ...
  return (
    <>
      <Head>
        <title> Multipurpose Frontity Theme by JS Template </title>
        {head}
      </Head>
      <div>
        <div
