...
const data = {
  ...
  manageWebsite: {
    title: "Everything You Need to Manage Your Classified Jobs Website",
    description:
      "Meta Jobs is the best classifieds jobs MERN Stack theme that will help you to develop scaleable jobs business website. Here are the key features",
    list: [
      {
