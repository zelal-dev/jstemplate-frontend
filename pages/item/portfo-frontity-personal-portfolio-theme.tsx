...
const colors = {
  ...
  bgPrimary: 'bg-[#000000]',
  buttonPrimary: 'bg-gradient-to-br from-[#000000] to-[#2d2d22d2]',
}
const livePreview = {
  title: 'Live Preview',
...
const MernStackDirectoryListingTheme = ( { seoData, foreignData }: { seoData: any, foreignData: any } ) => {
  const slug = 'portfo-frontity-personal-portfolio-theme'
  // call data using swr
  ...
  return (
    <>
      <Head>
        <title> Frontity Personal Portfolio Theme by JS Template </title>
        {head}
      </Head>
      <div>
        <div
