...
// page primary colors
const colors = {
	textPrimary: 'text-[#92003B]',
	bgPrimary: 'bg-[#65062d]',
	buttonPrimary: 'bg-gradient-to-br from-[#92003B] to-[#92003B]',
}
const livePreview = {
	title: 'Live Preview',
	link: '#',
...
const JamunaTheme = ( { seoData, foreignData }: { seoData: any, foreignData: any } ) => {
	...
	return (
		<>
			<Head>
				<title> Elementor Template Kits and Blocks Library </title>
				{head}
			</Head>
			<div>
				<div
