...
const ProjectDetails = () => {
    ...
    const [messageColor, setMessageColor ] = useState<string>("text-gray-900 font-semibold")
    const [messagePartSmall, setMessagePartSmall ] = useState<string>("hidden")
    const [messageColorSmall, setMessageColorSmall ] = useState<string>("text-gray-700 font-semibold")
    ...
    const [requirementColor, setRequirementColor ] = useState<string>("text-gray-700")
  ...
  return (
    <div>
        <Layout.AdminDashboard>
            <div className='md:py-7 md:px-12 p-2 bg-backgroundGrayOne overflow-y-auto' style={{ height: "calc(100vh - 75px)" }}>
                    ...
                    <div className='xl:col-span-6 col-span-12'>
                        <div className='bg-white rounded-lg p-6'>
                            <div className='flex items-center'>
                                <h3 className={`text-base  ${messageColor} mr-10`} onClick={handleMessageVisibility}>Messages</h3>
                                <h3 className={`text-base  ${requirementColor}`} onClick={handleRequirementVisibility}>Requirements</h3>
                            </div>
                            <div className='h-0.5 mt-4 w-full bg-backgroundGrayOne flex items-center'>
                                <div className={`h-0.5 w-20 ${messagePart} bg-blueTwo duration-150`} />
                                <div className={`h-0.5 w-28 ${requirementPart} bg-blueTwo duration-150 ml-28`} />
                            </div>
                ...
                <div className='lg:hidden block'>
                    <div className='bg-white rounded-lg p-6'>
                        <div className='flex items-center'>
                            <h3 className={`md:text-base text-sm  ${projectColor} xl:mr-10 lg:mr-9 md:mr-7 sm:mr-6 mr-5`} onClick={handleProjectVisibility}>Project Details</h3>
                            <h3 className={`md:text-base text-sm  ${messageColorSmall} xl:mr-10 lg:mr-9 md:mr-7 sm:mr-6 mr-5`} onClick={handleMessageVisibilitySmall}>Messages</h3>
                            <h3 className={`md:text-base text-sm  ${requirementColor}`} onClick={handleRequirementsVisibilitySmall}>Requirements</h3>
                        </div>
                        <div className='h-0.5 mt-4 w-full bg-backgroundGrayOne flex items-center'>
                            <div className={`h-0.5 md:w-28 w-24 ${projectPart} bg-blueTwo duration-150`} />
                            <div className={`h-0.5 md:w-20 w-16 ${messagePartSmall} bg-blueTwo duration-150 lg:ml-36 md:ml-32 ml-28`} />
                            <div className={`h-0.5 ms:w-28 w-24 ${requirementPart} bg-blueTwo duration-150 lg:ml-64 md:ml-60 ml-48`} />
                        </div>
                        <div>
