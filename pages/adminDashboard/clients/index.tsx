        ...
        <Layout.AdminDashboard>
            <div className='py-7 px-12 bg-backgroundGrayOne overflow-y-auto' style={{ height: "calc(100vh - 75px)" }}>
                <div className='flex items-center justify-between'>
                    ...
                    <button className='text-sm text-white py-2.5 px-4 rounded-md bg-blueTwo'>Add Client</button>
                </div>
                <h3 className='text-sm text-gray-900 font-semibold mt-8'>All Clients</h3>
                <div className='h-0.5 w-full mt-3 bg-[#eceef1]'>
                    <div className='h-0.5 bg-blueTwo w-[4.5rem]' />
                </div>
                <div className='mt-8 rounded-lg bg-white p-6'>
                    <div className='flex flex-col md:flex-row md:items-center md:justify-between'>
                        <h1 className='text-base text-gray-900 font-bold'>Client List</h1>
                    ...
                    <div className='2xl:grid grid-cols-12 mt-8 hidden'>
                        ...
                        <div className='col-span-1 py-4 bg-backgroundGrayOne'>
                            <h3 className='text-sm text-gray-900'>Buy Products</h3>
                        </div>
                        <div className='col-span-1 py-4 bg-backgroundGrayOne'>
                            <h3 className='text-sm text-gray-900'>Complete Project</h3>
                        </div>
                        <div className='col-span-1 py-4 pl-3 bg-backgroundGrayOne'>
                            <h3 className='text-sm text-gray-900'>Total Spent</h3>
                        </div>
                        <div className='col-span-1 py-4 pl-3 bg-backgroundGrayOne'>
                        ...
                        <div className='col-span-1 py-6 my-auto '>
                            <h3 className='text-sm text-gray-700'>12</h3>
                        </div>
                        <div className='col-span-1 py-6 my-auto '>
                            <h3 className='text-sm text-gray-700'>20</h3>
                        </div>
                        <div className='col-span-1 pl-4 py-6 my-auto '>
                            <h3 className='text-sm text-gray-700'>$20,000</h3>
                        </div>
                        <div className='col-span-1 pl-4 py-6 my-auto '>
                    ...
                    <div className='flex sm:flex-row flex-col justify-between items-center mt-6'>
                        <h2 className='tex-base font-bold text-gray-700'>Total 1234 Client</h2>
