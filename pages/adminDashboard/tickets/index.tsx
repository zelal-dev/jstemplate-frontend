        ...
        <Layout.AdminDashboard>
            <div className='py-7 px-12 bg-backgroundGrayOne overflow-y-auto' style={{ height: "calc(100vh - 75px)" }}>
                <div className='flex items-center justify-between'>
                    ...
                    <button className='text-sm text-white py-2.5 px-4 rounded-md bg-blueTwo'>Create Tickets</button>
                </div>
                <div className='items-center mt-8 sm:flex hidden'>
                    <h3 className='text-sm text-gray-900 font-semibold mr-8'>Active Ticket</h3>
                    <h3 className='text-sm text-gray-600 font-semibold mr-8'>New Ticket Request</h3>
                    <h3 className='text-sm text-gray-600 font-semibold mr-8'>Closed Ticket</h3>
                </div>
                ...
                <div className='mt-8 rounded-lg bg-white p-6'>
                    ...
                    <div className='2xl:grid grid-cols-12 mt-8 hidden'>
                        ...
                        <div className='col-span-4 py-6 my-auto '>
                            <h3 className='text-sm text-blueTwo'>Ticket Subject Here Lorem Ipsum Dummy Text...</h3>
                        </div>
                        <div className='col-span-2 py-6 my-auto  flex items-center'>
                            <h3 className='text-sm text-gray-700'>Ticket Category Here</h3>
                        </div>
                        ...
                        <div className='col-span-2 py-6  my-auto '>
                            <h3 className='text-white py-0.5 px-2.5 rounded-full text-xs bg-gradient-to-br from-greenLight to-greenDark inline'>Open</h3>
                        </div>
