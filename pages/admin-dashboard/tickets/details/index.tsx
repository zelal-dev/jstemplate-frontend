    ...
    return (
      <>
        <Layout.AdminDashboard>
          <div
            className="md:py-7 md:px-12 p-4 bg-backgroundGrayOne overflow-y-auto"
              ...
              <div className="md:col-span-3 col-span-12">
                <div className="p-6 bg-white rounded-lg border border-cartImageBgOne shadow-sm">
                  <h3 className="text-base text-gray-900">
                    Ticket Subject Here Lorem Ipsum Simple Dummy Text
                  </h3>
                  ...
                  <div className="flex flex-row md:flex-col lg:flex-row items-center justify-between mt-3">
                    ...
                    <h5 className="bg-gradient-to-br text-xs md:mt-2 lg:mt-0 from-greenLight to-greenDark py-0.5 px-2.5 rounded-full text-gray-100">
                      Open
                    </h5>
                  </div>
                  <hr className="w-full my-6 text-cartImageBgOne" />
                  <div className="flex 2xl:flex-row flex-col 2xl:items-center 2xl:justify-between">
                    <button className="text-sm text-gray-900 py-2.5 px-2.5 rounded-md bg-gray-200">
                      Send Give Review Message
                    </button>
                    <button className="text-sm text-white py-2.5 px-2.5 rounded-md bg-[#FA4F58] mt-3 2xl:mt-0">
                      Close Ticket
                    </button>
                  </div>
                </div>
              ...
              <div className="md:col-span-9 col-span-12">
                    ...
                    <div className="flex justify-between">
                      <div>
                        <h2 className="text-base font-bold text-gray-900">
                          User Name Here - Reply
                        </h2>
                        <h2 className="text-sm text-gray-600 mt-0.5">
                          Saturday 1:20 PM
                        </h2>
                      </div>
                ...
                <div className="grid grid-cols-12 p-8 gap-5 bg-white rounded-lg border border-cartImageBgOne shadow-sm mb-4">
                  ...
                  <div className="col-span-11">
                    ...
                    <button
                      className="text-sm py-3 px-6 rounded-lg text-gray-100 bg-gradient-to-br from-blueOne to-blueTwo mt-5"
                ...
                <div className="p-4 bg-white rounded-lg border border-cartImageBgOne shadow-sm mt-4">
                  <form action="">
                    ...
                    <div className="flex items-end justify-between">
                      ...
                      <button className="text-sm text-white py-3 px-5 rounded-md bg-[#FF7043] flex items-center">
                        <span className="hidden sm:block">Submit</span>
                        <FiSend className="w-[1.125rem] h-[1.125rem] sm:ml-4" />
                      </button>
                    </div>
                  </form>
                </div>
              ...
              <div className="xl:p-12 lg:p-10 md:p-8 sm:p-7 p-6 bg-white rounded-lg relative">
                ...
                <form action="" className="mt-7 flex flex-col items-center">
                  <div className="w-full flex items-center">
                    <div className="p-1.5 rounded-md bg-gradient-to-br from-greenLight to-greenDark mr-1.5">
                      <AiFillStar className="text-sm text-white" />
                    </div>
                    <div className="p-1.5 rounded-md bg-gradient-to-br from-greenLight to-greenDark mr-1.5">
                      <AiFillStar className="text-sm text-white" />
                    </div>
                    ...
                    <div className="p-1.5 rounded-md bg-gray-300 mr-1.5">
                      <AiFillStar className="text-sm text-white" />
                    </div>
                  </div>
                  <textarea
                    name=""
                    id=""
                    className="h-40 xl:w-96 lg:w-80 w-72 py-4 px-5 rounded-lg border border-[#DDE6F5] outline-none mt-4"
                    placeholder="Write your message..."
                  ></textarea>
                  <input
                    type="button"
