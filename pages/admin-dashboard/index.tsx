                ...
                <div className="w-full rounded-lg bg-white p-6">
                  ...
                  <div className="2xl:grid grid-cols-12 mt-6 hidden">
                    ...
                    <div className="col-span-4  py-6 my-auto ">
                      <h3 className="text-base text-blueTwo font-bold">
                    ...
                    <div className="col-span-1 px-4 py-6 my-auto ">
                      <h3 className="text-sm font-semibold text-blueTwo">
                        View Project
                      </h3>
                    </div>
...
const UserCart = () => {
  return (
    <div className="flex items-center border-b-2 border-backgroundGrayOne p-4">
      <div className="text-base font-bold text-white py-1.5 px-3 rounded-full bg-blueTwo mr-3">
        H
      </div>
      <div>
