    ...
    <div className={`bg-backgroundGrayOne min-h-screen ${layout} w-full`}>
        ...
        <div className='container mx-auto py-10 px-5 sm:px-0'>
            <div className='flex items-center justify-between'>
                ...
                <button onClick={handleTicketModal} className='text-sm py-3 px-6 rounded-lg text-gray-100 bg-gradient-to-br from-blueOne to-blueTwo'>Create New Ticket</button>
            </div>
            <div className='mt-8 p-7 bg-white rounded-lg border border-cartImageBgOne shadow-sm'>
                <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between'>
                    ...
                    <div className='mt-4 sm:mt-0'>
                        <button className='text-sm py-3 px-4 rounded-lg text-gray-700 bg-backgroundGrayOne mr-2'>Open</button>
                        <button className='text-sm py-3 px-4 rounded-lg text-gray-700 bg-backgroundGrayOne mr-2'>Awaiting</button>
                        <button className='text-sm py-3 px-4 rounded-lg text-gray-700 bg-backgroundGrayOne '>Closed</button>
                    </div>
                </div>
                <div className='lg:grid grid-cols-12 container mt-8 hidden'>
                    ...
                    <div className='col-span-4 px-4 py-6 my-auto '>
                        <h3 className='text-sm text-gray-700'>Ticket Subject Here Lorem Ipsum Dummy Text...</h3>
                    </div>
                    ...
                    <div className='col-span-2 px-4 py-6 my-auto '>
                        <h3 className='text-white py-0.5 px-2.5 rounded-full text-xs bg-gradient-to-br from-yellowLight to-yellowDark inline'>Awaiting</h3>
                    </div>
                    <div className='col-span-1 px-4 py-6 my-auto '>
                        <Link href="/dashboard/tickets/details" ><a className='text-sm text-blueTwo'>View Ticket</a></Link>
                    </div>
            ...
            <div className={`fixed w-full duration-300 h-screen ${modal} justify-center items-center top-0 left-0 right-0`}>
                <div className='xl:p-12 lg:p-10 md:p-8 sm:p-7 p-6 bg-white rounded-lg relative'>
                    <h1 className='text-2xl font-bold text-gray-900 sm:text-center'>Add New Ticket</h1>
                    <form action="" className='mt-7 flex flex-col items-center'>
                        ...
                        <input type="text"  className='xl:w-96 lg:w-80 md:w-72 w-64 py-4 px-5 rounded-lg border border-[#DDE6F5] outline-none mt-4' placeholder='Subject'/>
                        <textarea name="" id="" className='h-40 xl:w-96 lg:w-80 md:w-72 w-64 py-4 px-5 rounded-lg border border-[#DDE6F5] outline-none mt-4' placeholder='Write your message...'></textarea>
                        <input type="button" value="Submit Ticket" className='text-sm py-3 px-6 rounded-lg text-gray-100 bg-gradient-to-br from-blueOne to-blueTwo mt-6'/>
                    </form>
