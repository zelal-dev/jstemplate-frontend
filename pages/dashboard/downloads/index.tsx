    ...
    <div className='bg-backgroundGrayOne min-h-screen'>
        ...
        <div className='container mx-auto py-10 px-5 sm:px-5'>
            ...
            {sample.map((items, index)=>(
                <div key={index} className='grid grid-cols-12 container mb-4 bg-white rounded-lg'>
                    ...
                    <div className='lg:col-span-4 col-span-9 my-auto p-2.5 '>
                        <h3 className='text-base font-bold text-gray-900'>Simple and Awesome Product Title Here</h3>
                        <h3 className='text-sm text-gray-600'>Lorem Ipsum has been the industry standard dummy text</h3>
                    </div>
