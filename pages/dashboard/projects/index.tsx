        ...
        <div className='container mx-auto py-10 px-5 sm:px-0'>
            ...
            <div className='mt-8 p-7 bg-white rounded-lg border border-cartImageBgOne shadow-sm'>
                <div className='flex items-center'>
                    <h3 className='text-base font-semibold text-gray-900 mr-10'>Active</h3>
                    <h3 className='text-base font-semibold text-gray-900 mr-10'>Cancelled</h3>
                    <h3 className='text-base font-semibold text-gray-900 mr-10'>Completed</h3>
                </div>
