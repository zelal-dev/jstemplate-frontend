  ...
  return (
    <div className='bg-white mt-1 drop-shadow-sm'>
        <div className='container relative mx-auto flex items-center justify-between py-2 px-5 sm:px-0'>
          <VscListSelection className='w-6 h-6 block lg:hidden' onClick={handleSidebar} />
            ...
            <button className='text-sm text-white p-4 rounded-lg bg-gradient-to-br from-blueOne to-blueTwo flex items-center ' onClick={handleTicketModal}>Start Your Project Free</button>
            <div className={`absolute ${sidebar} lg:hidden rounded-lg shadow-xl p-3 top-20 bg-white w-60`}>
        ...
        <div className={`fixed ${modal} duration-300 w-full h-screen bg-gray-900 -top-28 left-0 right-0 bottom-0 opacity-50`} />
