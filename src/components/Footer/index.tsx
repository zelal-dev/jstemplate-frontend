  ...
  return (
    <div className='bg-gray-800 relative px-5'>
        <div className='container mx-auto'>
            <div className='bg-white absolute -top-40 left-5 right-5 sm:left-auto sm:right-auto sm:container xl:p-24 lg:p-20 md:p-16 sm:p-12 p-8 flex lg:flex-row flex-col items-center rounded-lg'>
                {/* <Image src={footerBg} /> */}
