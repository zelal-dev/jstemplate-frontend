        ...
        <div className='container mx-auto'>
            <div  className='bg-white  drop-shadow-2xl absolute -top-40 left-5 right-5 sm:left-auto sm:right-auto sm:container xl:p-24 lg:p-20 md:p-16 sm:p-12 p-8 flex lg:flex-row flex-col items-center justify-between rounded-lg'>
                ...
                <div className='flex items-start lg:w-3/4 w-full'>
                    <div className={`xl:w-24 xl:h-24 md:w-20 md:h-16 sm:w-16 w-36 h-14 rounded-md bg-gradient-to-br from-${boxFromColor} to-${boxToColor} lg:mr-10 sm:mr-6 mr-3 shadow-${shadowBox}`} />
                    <div>
            ...
            <div className='bg-gray-700 py-6 px-10 rounded-md flex md:flex-row flex-col items-center justify-between mt-16'>
                <div className='flex items-center'>
                    <div className='md:p-4 p-2 rounded-full bg-gradient-to-br shadow-green from-greenLight to-greenDark xl:mr-8 lg:mr-6 md:mr-5 sm:mr-4 mr-3'><FaCheck className='text-gray-100 xl:w-6 xl:h-5 lg:w-5 lg:h-4 md:w-4 md:h-3 w-3 h-2' /></div>
