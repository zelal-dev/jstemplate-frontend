...
import { KnowUsData } from "../../../data/know-us";
      ...
      <div className="container mx-auto relative z-0">
        <div className="bg-white rounded-ld xl:py-20 sm:py-16 py-14 flex flex-col items-center justify-center drop-shadow-xl rounded-xl">
          ...
          <div className="grid xl:grid-cols-4 lg:grid-cols-3 grid-cols-2 xl:gap-10 lg:gap-8 md:gap-7 sm:gap-6 gap-5 2xl:mt-14 xl:mt-12 lg:mt-10 md:mt-9 sm:mt-8 mt-7">
            {KnowUsData.map((item: any, index: any) => (
              <div
                className={`${
                  index === 0 || index === 2 ? "bg-backgroundGrayOne" : "border"
                } 2xl:py-12 xl:py-10 lg:py-8 md:py-7 sm:py-6 py-5 2xl:px-16 xl:px-14 lg:px-12 md:px-10 sm:px-9 px-8 flex flex-col items-center justify-center rounded-lg hover:scale-105 duration-300 cursor-pointer`}
