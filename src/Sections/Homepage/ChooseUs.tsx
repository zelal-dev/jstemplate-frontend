    ...
    <div className='container mx-auto relative z-0'>
        <div className='xl:py-24 sm:py-16 py-14 flex flex-col items-center justify-center'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-11 container mx-auto xl:my-16 md:mt-12 mt-8 px-5 lg:px-28 sm:px-16'>
                <div className='bg-backgroundGrayOne cursor-pointer p-10 rounded-lg flex flex-col items-center justify-center hover:bg-white hover:drop-shadow-xl ease-in duration-200' style={{boxShadow:`${boxShadowOne}`}} onMouseOver={handleMouseOverOne} onMouseOut={handleMouseOutOne}>
                ...
                <div className='bg-backgroundGrayOne cursor-pointer p-10 rounded-lg flex flex-col items-center justify-center  hover:bg-white hover:drop-shadow-xl ease-in duration-200' style={{boxShadow:`${boxShadowTwo}`}} onMouseOver={handleMouseOverTwo} onMouseOut={handleMouseOutTwo}>
                ...
                <div className='bg-backgroundGrayOne cursor-pointer p-10 rounded-lg flex flex-col items-center justify-center  hover:bg-white hover:drop-shadow-xl ease-in duration-200' style={{boxShadow:`${boxShadowThree}`}} onMouseOver={handleMouseOverThree} onMouseOut={handleMouseOutThree}>
                ...
                <div className='bg-backgroundGrayOne cursor-pointer p-10 rounded-lg flex flex-col items-center justify-center  hover:bg-white hover:drop-shadow-xl ease-in duration-200' style={{boxShadow:`${boxShadowFour}`}} onMouseOver={handleMouseOverFour} onMouseOut={handleMouseOutFour}>
                ...
                <div className='bg-backgroundGrayOne cursor-pointer p-10 rounded-lg flex flex-col items-center justify-center  hover:bg-white hover:drop-shadow-xl ease-in duration-200' style={{boxShadow:`${boxShadowFive}`}} onMouseOver={handleMouseOverFive} onMouseOut={handleMouseOutFive}>
                ...
                <div className='bg-backgroundGrayOne cursor-pointer p-10 rounded-lg flex flex-col items-center justify-center  hover:bg-white hover:drop-shadow-xl ease-in duration-200' style={{boxShadow:`${boxShadowSix}`}} onMouseOver={handleMouseOverSix} onMouseOut={handleMouseOutSix}>
