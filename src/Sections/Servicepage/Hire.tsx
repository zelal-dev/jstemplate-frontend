...
const Hire=()=> {
  return (
    <div className='px-5 sm:px-0 2xl:py-28 xl:py-24 lg:py-20 md:py-16 py-14 '>
        <div className='service-hire-part container mx-auto xl:p-24 lg:p-20 md:p-16 sm:p-10 p-8  flex flex-col items-center justify-center rounded-lg '>
            ...
            <button className='text-base font-semibold drop-shadow-lg mt-16 text-templateColor flex items-center bg-gray-100 py-4 px-6 rounded-lg'><IoChatbubbles className='mr-4 drop-shadow-xl' /> Start a Project</button>
        </div>
    </div>
  )
}
