...
const Header=()=> {
  return (
    <div className='xl:py-36 lg:py-28 md:py-24 sm:py-20 py-16 px-5 sm:px-0 flex items-center flex-col lg:flex-row justify-between container mx-auto'>
        <div className='lg:w-3/5 sm:w-4/5 w-full mg:mr-16 mr-0  lg:pr-20 pr-0'>
            <h1 className='2xl:text-7xxl xl:text-7xl lg:text-5xl md:text-4xl sm:text-3xl text-2xl text-gray-100 xl:leading-24 lg:leading-16 md:leading-10 sm:leading-9 leading-8 font-black text-center lg:text-left' style={{textShadow:"8px 8px 0px #459B4B"}}>MERN Stack Web Development</h1>
        ...
        <div className='xl:p-10 lg:p-8 md:p-7 sm:p-6 p-5 rounded-lg bg-gray-100 lg:w-2/5 sm:w-3/4 w-full mt-16 lg:mt-0'>
            ...
            <div className='mt-8 p-4 rounded-md border border-grayLight'>
                ...
                <div className='mt-8 flex justify-between flex-col sm:flex-row lg:flex-col xl:flex-row xl:items-center'>
                ...
                <div className='mt-8 flex justify-between flex-col xl:flex-row sm:flex-row lg:flex-col xl:items-center'>
            ...
            <div className='mt-6'>
                <button className='text-gray-100 mr-2 text-sm font-medium p-4 rounded-lg bg-gradient-to-r from-greenSecondaryLight to-greenSecondaryDark'>Start Your Project Free</button>
