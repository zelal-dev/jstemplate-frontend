  ...
  return (
    <div className="container mx-auto">
      <div className="xl:py-24 sm:py-16 py-14 flex flex-col items-center justify-center">
        <h5 className="xl:text-base md:text-sm text-xs text-templateColor">
          FAQ’s
        </h5>
  ...
  return (
    <div className="xl:p-8 lg:p-7 md:p-6 p-5  mb-5 rounded-lg shadow-md hover:shadow-grayLight duration-200 sm:w-3/4 w-full mx-auto">
      <div className="flex justify-between items-center">
        <h1 className="xl:text-lg md:text-base text-sm  tex-gray-900 font-bold">
          Simple and Awesome Question Title Here ?
        </h1>
        <button className="group">+</button>
      </div>
      <div className="mt-5 lg:text-base text-sm text-gray-600">
