  ...
  return (
    <div className=' flex flex-col items-center xl:pt-36 lg:pt-32 md:pt-24 sm:pt-20 pt-16 lg:pb-[21rem] sm:pb-72 pb-72'>
        <div className='relative w-2/3 sm:w-auto'>
            ...
            <div className='absolute lg:-top-6 lg:-right-14 md:-top-8 md:-right-16 sm:-top-7 sm:-right-14 -top-7 -right-8  md:py-2 py-1 md:px-3 px-2 rounded-md bg-gradient-to-br from-orangeOne to-orangeTwo text-sm text-gray-100'>Pre-Sale</div>
        </div>
        <article className='text-gray-100 xl:text-xl lg:text-lg sm:text-base text-sm lg:w-2/5 sm:w-2/4 w-3/4 text-center mt-6'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text</article>
        <h4 className='text-gray-100 xl:text-xl lg:tex-lg md:text-base text-sm tracking-largest mt-14'>BUILT WITH</h4>
