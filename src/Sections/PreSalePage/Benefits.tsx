...
const BenefitNormalCart = () => {
  return (
    ...
    >
      ...
      <button className="text-gray-100 text-base font-semibold bg-gradient-to-br from-secondaryTemplateColorLight to-secondaryTemplateColorDark w-full py-4 rounded-lg mt-8 shadow-secondaryTemplate">
        Buy Now
      </button>
      <div className="flex justify-center mt-7">
        <button className="text-gray-700 tex-base mx-auto flex items-center">
  ...
  return (
    <div className="rounded-lg relative overflow-hidden bg-secondaryTemplateColorDark shadow-secondaryTemplate">
      ...
      <div className="px-10 py-12 z-20 relative">
        ...
        <button className="text-secondaryTemplateColorDark text-base font-semibold bg-white w-full py-4 rounded-lg mt-8 shadow-secondaryTemplate">
          Buy Now
        </button>
        <div className="flex justify-center mt-7">
          <button className="text-gray-100 tex-base mx-auto flex items-center">
            <span>See Details</span>{" "}
