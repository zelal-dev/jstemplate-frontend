  ...
  return (
    <div className="px-5 sm:px-0 2xl:pt-28 xl:pt-24 lg:pt-20 md:pt-16 pt-14 ">
      <div
        ...
        className="container mx-auto xl:p-24 lg:p-20 md:p-16 sm:p-10 p-8  flex flex-col items-center justify-center rounded-lg "
      >
        ...
        <button
          type="button"
          className="text-base font-semibold drop-shadow-lg mt-16 text-secondaryTemplateColorDark flex items-center bg-gray-100 py-4 px-6 rounded-lg"
        >
